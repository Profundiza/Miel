...
urlpatterns = [
    ...
    url(r'^platillos/exportar/$', export.export, name='platillos_export'),
    ...
    url(r'^ingredientes/exportar/$', export.export, name='ingredientes_export'),
    ...
    url(r'^recetas/exportar/$', export.export, name='recetas_export'),
]
